"""
N=20 client CIFAR-10 scale validation (4x5 game, 5 seeds).
Attacks: no_attack, backdoor_pixel, model_scaling, dba
Defenses: fedavg, norm_clip, rfa, trimmed_mean, coord_median

Mirrors run_cifar10_50clients.py exactly except num_clients=20,
clients_per_round=4 (maintaining 20% adversarial fraction).

Output: results/cifar10_20clients/
"""
import sys, os, json
import numpy as np
...
output_dir = os.path.join(base_dir, "results", "cifar10_20clients")
os.makedirs(output_dir, exist_ok=True)

print(f"N=20 CIFAR-10 scale validation: 4x5 game, {len(SEEDS)} seeds")
